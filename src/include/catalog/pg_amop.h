 ...
 * btree tsquery_ops
 */
DATA(insert (	4151   3615 3615 1 s	3674 4040 0 ));
DATA(insert (	4151   3615 3615 2 s	3675 4040 0 ));
DATA(insert (	4151   3615 3615 3 s	3676 4040 0 ));
DATA(insert (	4151   3615 3615 4 s	3678 4040 0 ));
DATA(insert (	4151   3615 3615 5 s	3679 4040 0 ));


/*
 * idist range_ops
 */
DATA(insert (	4152   3831 3831 1 s	3884 4040 0 ));
DATA(insert (	4152   3831 3831 2 s	3885 4040 0 ));
DATA(insert (	4152   3831 3831 3 s	3882 4040 0 ));
DATA(insert (	4152   3831 3831 4 s	3886 4040 0 ));
DATA(insert (	4152   3831 3831 5 s	3887 4040 0 ));
