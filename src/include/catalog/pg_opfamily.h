...
DATA(insert OID =  4120 (	4040		abstime_ops		PGNSP PGUID ));
...
DATA(insert OID = 4147 (	4040		tinterval_ops	PGNSP PGUID ));
DATA(insert OID = 4148 (	4040		uuid_ops		PGNSP PGUID ));
DATA(insert OID = 4149 (	4040		enum_ops		PGNSP PGUID ));
DATA(insert OID = 4150 (	4040		tsvector_ops	PGNSP PGUID ));
DATA(insert OID = 4151 (	4040		tsquery_ops		PGNSP PGUID ));
DATA(insert OID = 4152 (	4040		range_ops		PGNSP PGUID ));
